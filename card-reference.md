# 21 -- Card Art Reference Guide

All reference photos are in the assets folder. Draw your own versions of these in the fun 2D illustrated style (thick outlines, flat colors, bold numbers).
...
**Card vibe:** Minimal. One subject, one object. The quietest card in the deck.
**Color zone:** Cool blue / soft green
...
**Card vibe:** One flower, slightly more going on. Still clean and simple.
**Color zone:** Yellow / green
...
**Card vibe:** First card with two subjects. Playful, a little mischievous.
**Color zone:** Yellow / warm green
...
**Card vibe:** Dynamic movement. Multiple flowers and branches. More action than earlier cards.
**Color zone:** Green / yellow
...
**Card vibe:** The midpoint card. Big personality. This will be the fan favorite.
**Color zone:** White / warm green / orange fur
...
**Card vibe:** Height, ambition, more environment visible. The scene feels bigger.
**Color zone:** Blue sky / yellow / green
...
**Card vibe:** Mood shift. Dark backdrop, golden spheres. Visual density increasing.
**Color zone:** Gold / black / dark
...
**Card vibe:** Wide, graceful composition. Thorny branch with beauty. Calm before the storm.
**Color zone:** Soft green / white / pink tint
...
**Card vibe:** Intimate, emotional. Large flowers dominate. High visual weight.
**Color zone:** Deep yellow / warm brown
...
**Card vibe:** The busiest card. Three subjects, lots of berries, autumn leaves. Controlled chaos.
**Color zone:** Red berries / autumn green / brown
...
**Card vibe:** The crown card. Regal, panoramic. Tiny kings surveying their kingdom.
**Color zone:** Blue / green meadow / earth tones
...
- **Number cards**: Bold number in top-left and bottom-right corners
- **Trump cards**: Gold/holographic border to distinguish from number cards, card name at top, tiny effect text at bottom
- **All cards**: Thick black outlines, flat colors with minimal shading, same border/frame shape
- **Card back**: Sleeping rat curled up in a closed flower bud, dark background, "21" watermark
- **Style**: Fun 2D illustrated, similar to a colorful indie card game
- **Dimensions**: Recommend drawing at 750x1050px (standard card ratio 5:7)
